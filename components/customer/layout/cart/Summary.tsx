...
export default function Summary() {
  return (
    <aside className="w-full h-auto py-4 px-6 md:py-6 md:px-10 xl:py-4 xl:px-6 rounded-xl bg-card-background border border-border flex flex-col items-center justify-center gap-4 ">
      <h2 className="text-preset-2 uppercase">Order Summary</h2>
      <Divider />
